...
const Information = () => {
  return (
    <div className='max-w-[1320px] m-auto w-full mt-10 bg-white '>
        <h1 className='text-center font-bold text-3xl drop-shadow-lg text-amber-500 tracking-wide'> About us</h1>
        <div className='flex flex-col md:flex-row mt-6'>
            <div className='md:w-1/2 p-4'>
            <h1 className='font-semibold text-center text-2xl p-3 drop-shadow-lg text-amber-300'>A beautiful garden is a work of Art</h1>
